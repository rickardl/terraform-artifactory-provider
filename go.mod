module github.com/rickardl/terraform-artifactory-provider

replace github.com/rickardl/go-artifactory/v2 => /Users/rickardlofstrom/rickardl/go-artifactory
...
require (
	...
	github.com/rickardl/go-artifactory/v2 v2.5.6
